...
module.exports = async (bot, shard) => {
    ...
    // Manager.spawn(3);
    // Manager.on('launch', shard => console.log(`- Spawned shard ${shard.id} | total shards ${shard.totalshards} -`));
    console.log(`${bot.user.username} is online | ${bot.shard.id} ${bot.shard.names}`)
